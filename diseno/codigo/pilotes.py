...
with the SAP2000 v27.1 forces (diseno/esfuerzos.py) and the fibre-section engine (seccion.py).
...
diseno/investigacion/codigo_estructural_spec.md) and is used for the parity with Anejo 10;
...
REF_JSON = DISENO / "ref" / "cype_design_reference.json"
...
def to_markdown(res: dict) -> str:
    ...
    md = [f"# Pilotes 40x40 HA-50: comprobación a Código Estructural (base {m['basis']}, modo {m['mode']})\n",
          "Generated by `python3 diseno/codigo/pilotes.py` (diseno/codigo/pilotes.py). Forces: SAP2000 v27.1. "
